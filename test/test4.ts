...
async function setUsdPriceModule(usdPriceModule: UsdPriceModule) {
    ...
    console.log("ghst price: ", await usdPriceModule.getAssetUsdPrice(ghstAddress));
    console.log("quick price: ", await usdPriceModule.getAssetUsdPrice(quickAddress));
}
...
describe("scenario 4",async () => {
    it('rebalancing 4번, ghst/quick 포함',async () => {
        ...
        let productBalance_quick_5 = (await product.assetBalance(quickAddress)).toString();
        let productBalance_ghst_5 = (await product.assetBalance(ghstAddress)).toString();
        let productValue_quick_5 = (await product.assetValue(quickAddress)).toString();
        let productValue_ghst_5 = (await product.assetValue(ghstAddress)).toString();
        ...
        let productBalance_quick_6 = (await product.assetBalance(quickAddress)).toString();
        let productBalance_ghst_6 = (await product.assetBalance(ghstAddress)).toString();
        let productValue_quick_6 = (await product.assetValue(quickAddress)).toString();
        let productValue_ghst_6 = (await product.assetValue(ghstAddress)).toString();
        ...
        let productBalance_quick_7 = (await product.assetBalance(quickAddress)).toString();
        let productBalance_ghst_7 = (await product.assetBalance(ghstAddress)).toString();
        let productValue_quick_7 = (await product.assetValue(quickAddress)).toString();
        let productValue_ghst_7 = (await product.assetValue(ghstAddress)).toString();
        ...
        let productBalance_quick_8 = (await product.assetBalance(quickAddress)).toString();
        let productBalance_ghst_8 = (await product.assetBalance(ghstAddress)).toString();
        let productValue_quick_8 = (await product.assetValue(quickAddress)).toString();
        let productValue_ghst_8 = (await product.assetValue(ghstAddress)).toString();
        ...
        let productBalance_quick_9 = (await product.assetBalance(quickAddress)).toString();
        let productBalance_ghst_9 = (await product.assetBalance(ghstAddress)).toString();
        let productValue_quick_9 = (await product.assetValue(quickAddress)).toString();
        let productValue_ghst_9 = (await product.assetValue(ghstAddress)).toString();
